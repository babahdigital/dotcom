...
Redux::setSection( $opt_name, array(
	...
	array(
    	...
    	array(
    		'id' => 'post_meta_author_link',
    		'title' => esc_html__( 'Post Author Link', 'jevelin' ),
    		'subtitle' => esc_html__( 'Enable or disable author link', 'jevelin' ),
    		'type' => 'button_set',
    		'options' => array(
    			'off' => esc_html__( 'Off', 'jevelin' ),
    			'on' => esc_html__( 'On', 'jevelin' ),
...
Redux::setSection( $opt_name, array(
	...
	array(
    	...
    	array(
    		...
    		'title' => esc_html__( 'Categories', 'jevelin' ),
    		'subtitle' => esc_html__( 'Enable or disable categories in single portfolio page', 'jevelin' ),
    		'type' => 'button_set',
    		'options' => array(
    			'off' => 'Off',
    			'on' => esc_html__( 'On', 'jevelin' ),
